...
export default function Expenses() {
  ...
  const exportPDF = () => {
    ...
    doc.setFontSize(10);
    doc.text(`Period: ${format(new Date(startDate), 'dd MMM yyyy')} to ${format(new Date(endDate), 'dd MMM yyyy')}`, 105, 36, { align: 'center' });
    ...
    doc.text(`Date of Generation: ${format(new Date(), 'dd MMM yyyy HH:mm')}`, 130, 72);
      ...
      <Box sx={{ p: { xs: 2, md: 4 }, pb: 12 }}>
        ...
        <Grid container spacing={3}>
            ...
            <Stack spacing={2} sx={{ height: '100%' }}>
                ...
                <CardContent sx={{ p: 3 }}>
                    <Stack direction="row" alignItems="center" spacing={1.5} sx={{ mb: 1 }}>
                        ...
                        <Typography variant="overline" sx={{ fontWeight: 800, letterSpacing: 1, color: 'text.secondary' }}>Total Credits</Typography>
                    </Stack>
                    <Typography variant="h4" sx={{ fontWeight: 900, color: 'success.main', fontFamily: 'var(--font-heading)' }}>
                ...
                <CardContent sx={{ p: 3 }}>
                    <Stack direction="row" alignItems="center" spacing={1.5} sx={{ mb: 1 }}>
                        ...
                        <Typography variant="overline" sx={{ fontWeight: 800, letterSpacing: 1, color: 'text.secondary' }}>Total Debits</Typography>
                    </Stack>
                    <Typography variant="h4" sx={{ fontWeight: 900, color: 'error.main', fontFamily: 'var(--font-heading)' }}>
                ...
                <CardContent sx={{ p: 3 }}>
                    <Typography variant="overline" sx={{ fontWeight: 800, letterSpacing: 2, opacity: 0.8 }}>Net Settlement</Typography>
                    <Typography variant="h3" sx={{ fontWeight: 900, my: 1, fontFamily: 'var(--font-heading)' }}>
                    Rs.{netBalance.toLocaleString()}
                    </Typography>
                    <Box sx={{ position: 'absolute', right: -15, bottom: -15, opacity: 0.15 }}>
          ...
          <Grid size={{ xs: 12, md: 8 }}>
            <Paper sx={{ p: 4, borderRadius: 5, border: `1px solid ${alpha(theme.palette.divider, 0.1)}`, height: '100%', boxShadow: '0 10px 30px rgba(0,0,0,0.02)' }}>
            ...
            <Paper sx={{ borderRadius: 5, overflow: 'hidden', border: `1px solid ${alpha(theme.palette.divider, 0.1)}`, boxShadow: '0 4px 20px rgba(0,0,0,0.02)' }}>
              ...
              <TableContainer sx={{ maxHeight: 600 }}>
                <Table stickyHeader>
                      <TableHead>
                        <TableRow>
                          <TableCell sx={{ fontWeight: 900, bgcolor: 'background.paper', fontSize: '0.85rem' }}>Transaction Date</TableCell>
